Shader "Skybox/Procedural/HLSL_Skybox"
{
	Properties
	{
		...
		[Toggle(CLOUDS)] _CLOUDS("Enable clouds", Float) = 1
...
#else
				float3 combined = skyGradients + sunAndMoon + sunsetColoured + stars + horizonGlow;
#endif
